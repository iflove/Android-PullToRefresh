...
public final class PullToRefreshRecyclerViewListActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ptr_recycle_list);

        mPullRefreshListView = (PullToRefreshRecyclerView) findViewById(R.id.pull_refresh_list);

        // Set a listener to be invoked when the list should be refreshed.

        mPullRefreshListView.setOnRefreshListener(new OnRefreshListener<RecyclerView>() {
            @Override
        ...
        mPullRefreshListView.setOnLastItemVisibleListener(new OnLastItemVisibleListener() {
            ...
            public void onLastItemVisible() {
                Toast.makeText(PullToRefreshRecyclerViewListActivity.this, "End of List!", Toast.LENGTH_SHORT).show();
            }
        });
         ...
         */
        SoundPullEventListener<RecyclerView> soundListener = new SoundPullEventListener<RecyclerView>(this);
        ...
        mPullRefreshListView.setAdapter(new RecyclerView.Adapter() {
            @Override
            ...
            public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
                ((ViewHolder) holder).textView.setText(mListItems.get(position));
            }
        ...
        mAdapter = mPullRefreshListView.getAdapter();
    }
    ...
    private class GetDataTask extends AsyncTask<Void, Void, String[]> {
        ...
        protected void onPostExecute(String[] result) {
            ...
            mPullRefreshListView.notifyDataSetChanged();
