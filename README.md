...
Android-PullToRefresh 复活了,一个强大的Andriod 下拉刷新框架,支持RecyclerView ,ListView...


# 前言
最近想开发一个共用的下拉刷新组件,便研究研究优秀的Android-PullToRefresh, 可惜这个优秀库不维护了/(ㄒoㄒ)/~~,
所以便将它转为AndroidStudio 工程，加入了RecyclerView的支持,方便大家学习~
 
# Android-PullToRefresh库 github 地址
